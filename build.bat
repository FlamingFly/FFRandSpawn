...
set PROJ_NAME=FFRandSpawn
set SRC_DIR=h:\works\KillingFloor\FFRandSpawn\sources\FFRandSpawn
set GAME_DIR=c:\Program Files (x86)\Steam\SteamApps\common\KillingFloor
set BUILD_DIR=h:\works\KillingFloor\FFRandSpawn-builds
set POSTBUILD=TRUE
...
xcopy /I "%SRC_DIR%\Classes\*.ini" "%GAME_DIR%\System\" >NUL
if errorlevel 1 goto :err
exit /B 0